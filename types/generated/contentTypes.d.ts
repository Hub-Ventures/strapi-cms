...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Categorias para clasificar contenido';
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Multi-tenant Clients';
    displayName: 'Client';
    pluralName: 'clients';
    singularName: 'client';
  };
  ...
  attributes: {
    api_token: Schema.Attribute.String & Schema.Attribute.Private;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFolderFolder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hierarchical folders for organizing pages';
    displayName: 'Folder';
    pluralName: 'folders';
    singularName: 'folder';
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['text', 'image', 'html']> &
